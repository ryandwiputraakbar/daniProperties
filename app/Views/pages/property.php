 ...
 <main id="main">
         ...
         <div class="container" data-aos="fade-up">
             ...
             <div class="row">
                 <div class="col-lg-3 col-md-6">
                     <div class="member">
                         <div class="pic"><img src="../../assets/img/products/produk1.jpeg" alt=""></div>
                         <div class="details">
                             <h4>BSD</h4>
                             <span>Properti BSD</span>
                             <div class="social">
                 ...
                 <div class="col-lg-3 col-md-6">
                     <div class="member">
                         <div class="pic"><img src="../../assets/img/products/produk2.jpg" alt=""></div>
                         <div class="details">
                             <h4>LIPPO</h4>
                             <span>Properti Lippo</span>
                             <div class="social">
                                 <a href=""><i class="bi bi-twitter"></i></a>
                                 <a href=""><i class="bi bi-facebook"></i></a>
                                 <a href=""><i class="bi bi-instagram"></i></a>
                 ...
                 <div class="col-lg-3 col-md-6">
                     <div class="member">
                         <div class="pic"><img src="../../assets/img/products/produk3.jpg" alt=""></div>
                         <div class="details">
                             <h4>KARAWACI</h4>
                             <span>Properti Karawaci</span>
                             <div class="social">
                                 <a href=""><i class="bi bi-twitter"></i></a>
                                 <a href=""><i class="bi bi-facebook"></i></a>
                                 <a href=""><i class="bi bi-instagram"></i></a>
                 ...
                 <div class="col-lg-3 col-md-6">
                     <div class="member">
                         <div class="pic"><img src="../../assets/img/products/produk4.jpg" alt=""></div>
                         <div class="details">
                             <h4>ALAM SUTERA</h4>
                             <span>Properti Alam Sutera</span>
                             <div class="social">
                                 <a href=""><i class="bi bi-twitter"></i></a>
                                 <a href=""><i class="bi bi-facebook"></i></a>
                                 <a href=""><i class="bi bi-instagram"></i></a>
     ...
     <section id="testimonials" style="display: none;">
         <div class="container" data-aos="fade-up">
             ...
             <div class="testimonials-slider swiper-container" data-aos="fade-up" data-aos-delay="100" style="display: none;">
                 <div class="swiper-wrapper">
         ...
         <div class="container" data-aos="zoom-out">
             <div class="row">
                 <div class="col-lg-9 text-center text-lg-start">
                     <h3 class="cta-title">Hubungi saya disini</h3>
                     <p class="cta-text"> Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                 </div>
                 <div class="col-lg-3 cta-btn-container text-center">
                     <a class="cta-btn align-middle" href="#">Button WA</a>
                 </div>
             </div>
         </div>
